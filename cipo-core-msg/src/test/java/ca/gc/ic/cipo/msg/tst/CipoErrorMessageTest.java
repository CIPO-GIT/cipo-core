	...
	@Test
 	public void testGetMessage() {
		...
		assertEquals("CipoErrorMessageTest - testGetMessage(1) result", 
					"Exception number 1.", msg1.getMessage(Locale.ENGLISH));
		assertEquals("CipoErrorMessageTest - testGetMessage(1) result", 
				"Exception numéro 1.", msg1.getMessage(Locale.FRENCH));
		...
		assertEquals("CipoErrorMessageTest - testGetMessage(4) result", 
				"Test Exception number 2 created by CIPO.", msg4.getMessage(Locale.ENGLISH));
		assertEquals("CipoErrorMessageTest - testGetMessage(4) result", 
				"Exception test numéro 2 créé par CIPO.", msg4.getMessage(Locale.FRENCH));
		...
		assertEquals("CipoErrorMessageTest - testGetMessage(5) result", 
				"Test Exception number 2 created by CIPO.", msg5.getMessage(Locale.ENGLISH));
		assertEquals("CipoErrorMessageTest - testGetMessage(5) result", 
				"Exception test numéro 2 créé par CIPO.", msg5.getMessage(Locale.FRENCH));
		
		// Test No. 6 - Lookup for a simple error message (English and French) by do 
		// not specifying the provider.
 		CipoErrorMessage msg6 = new CipoErrorMessage("ERR", -99, 1);
		assertEquals("CipoErrorMessageTest - testGetMessage(6) result", 
				"Exception number 1.", msg6.getMessage(Locale.ENGLISH));
		assertEquals("CipoErrorMessageTest - testGetMessage(6) result", 
				"Exception numéro 1.", msg6.getMessage(Locale.FRENCH));
 	} 	 	
}
